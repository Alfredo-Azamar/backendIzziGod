...
class LlamadaController extends AbstractController {
  ...
  protected initRoutes(): void {
    ...
    this.router.get("/emocionesPorDiaAgente/:id", this.getEmotionPerAgent.bind(this));
    this.router.get("/infoIncidencias", this.getInfoIncidents.bind(this));
    this.router.get("/infoTarjetas", this.getInfoCallCards.bind(this));
    ...
    this.router.get("/obtenerSentimiento/:IdLlamada",this.getSentiment.bind(this));
